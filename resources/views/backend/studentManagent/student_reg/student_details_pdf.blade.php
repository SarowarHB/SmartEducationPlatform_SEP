...
<table id="customers">
  <tr>
   <td><h2>
  <?php $image_path = '/upload/sep.png'; ?>
  <img src="{{ public_path() . $image_path }}" width="200" height="200">

    </h2></td>
    <td><h2>Smart Education Platform</h2>
<p>University Address</p>
<p>Phone : 999999999</p>
<p>Email : support@sepbd.com</p>
...
<table id="customers">
  ...
  <tr>
    ...
    <td>13</td>
    <td><b>Year </b></td>
    <td>{{ $details['student_year']['yearName'] }}</td>
  </tr>
    <tr>
    <td>14</td>
    <td><b>Class  </b></td>
    <td>{{ $details['student_class']['className'] }}</td>
  </tr>
    <tr>
    <td>15</td>
    <td><b>Group </b></td>
    <td>{{ $details['group']['departmentName'] }}</td>
  </tr>
