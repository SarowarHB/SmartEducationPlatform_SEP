...
<div class="col-md-4">
 ...
 <option value="{{ $year->id }}" {{ ($editData->year_id == $year->id)? "selected":"" }}  >{{ $year->yearName }}</option>
		 	@endforeach
	 ...
	 <select name="class_id"  required="" class="form-control">
			...
			<option value="{{ $class->id }}" {{ ($editData->class_id == $class->id)? "selected":"" }} >{{ $class->className }}</option>
		 	@endforeach
...
<div class="col-md-4">
	 ...
	 <select name="department_id"   required="" class="form-control">
			...
			<option value="{{ $department->id }}" {{ ($editData->department_id == $department->id)? "selected":"" }} >{{ $department->departmentName }}</option>
		 	@endforeach
