...
<section class="content">
 ...
 <form method="post" action="{{ route('update.assign.subject',$editData[0]->department_id) }}">
	 	@csrf
					  <div class="row">
						<div class="col-12">
						<div class="add_item">
	...
	<div class="controls">
	 <select name="class_id" required="" class="form-control">
		...
		<option value="{{ $department->id }}" {{ ($editData['0']->department_id == $department->id)? "selected":"" }} >{{ $department->departmentName  }}</option>
		@endforeach	 
		</select>
	 </div>
          </div> <!-- // end form group -->
   ...
   <div class="form-group">
	...
	<div class="controls">
	 <select name="subject_id[]" required="" class="form-control">
		...
		<option value="{{ $subject->id }}" {{ ($edit->subject_id == $subject->id)? "selected": ""  }}>{{ $subject->subjectName }}</option>
		@endforeach	 
		</select>
	 </div>
          </div> <!-- // end form group -->
