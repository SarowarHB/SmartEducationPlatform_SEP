                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <form action="{{ route('advising.store',$editData->student_id)}}" method="post">
                                @csrf
                                <input type="hidden" name="class_id" value="{{$editData->class_id}}">
                                <input type="hidden" name="department_id" value="{{$editData->department_id}}">
