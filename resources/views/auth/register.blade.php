...
<head>
    ...
    <title>SEP Admin - Registration </title>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email"
                                            class="form-control pl-15 bg-transparent text-white plc-white" id="email" 
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password"
                                            class="form-control pl-15 bg-transparent text-white plc-white" id="password"
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password"
                                            class="form-control pl-15 bg-transparent text-white plc-white" id="password_confirmation"
